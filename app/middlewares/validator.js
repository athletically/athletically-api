...
let updateProfileValidateSchema = Joi.object({
    ...
    country : Joi.string(),
    city : Joi.string(),
    competition_won : Joi.string(),
    previous_teams : Joi.string(),
    previous_coaches : Joi.string(),
    game_id : Joi.string(),
    ...
    awards : Joi.string(),
    medals : Joi.string(),
    previous_clubs : Joi.string(),
    age : Joi.string(),
    certifications : Joi.string(),
    home_ground : Joi.string(),
    map_link : Joi.string(),
    team_size : Joi.string(),
    managements : Joi.string(),
    coaches : Joi.string(),
    other_stuffs : Joi.string(),
    players : Joi.string(),
    titles : Joi.string(),
    alumni_players : Joi.string(),
    active_competitions : Joi.string(),
    org_type : Joi.string(),
    org_desc : Joi.string(),
    estd : Joi.string(),
